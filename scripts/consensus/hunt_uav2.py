...
class Follower:
    def __init__(self):
        ...
        # self.rcin_sub = rospy.Subscriber('/uav3/mavros/rc/in', RCIn, self.rcin_callback)
        self.leader_local_pose_sub = rospy.Subscriber('/uav3/mavros/local_position/pose', PoseStamped, self.leader_pose_callback)
        self.leader_global_pose_sub = rospy.Subscriber('/uav3/mavros/global_position/global', NavSatFix, self.leader_global_pose_callback)
        ...
        self.uav1_local_pose_sub =rospy.Subscriber('/uav1/mavros/local_position/pose', PoseStamped, self.uav1_local_pose_callback,queue_size=2)
        '''
        ros publishers
        '''
    ...
    def get_setpoint_motion(self,x=0, y=0, z=0, vx=0, vy=0, vz=0, afx=0, afy=0, afz=0, yaw=0, yaw_rate=0):
        self.setpoint_motion.header.stamp = rospy.Time.now()
