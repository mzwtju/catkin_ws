...
class Follower:
    def __init__(self):
        ...
        # self.formation_position_pub = rospy.Publisher('/uav1/formation_pose',Pose,queue_size=2)
        '''
        ros services
        '''
    ...
    def start(self):
        ...
        while not rospy.is_shutdown():
            ...
            formation_vel_x = delta_vel(formation_p_x,self.relative_pose2.pose.position.x,KP_x,vel_max_xy) #target - current 
            ...
            if all_ready == 1 :
                ...
                formation_vel_x = -tmp_x
                formation_vel_y = -tmp_y
            ...
            if self.count == 20:
                ...
                #                         self.local_pose.pose.position.x))                # print("local_position x:%.2f y:%.2f"%(self.local_pose.pose.position.x,self.local_pose.pose.position.y))
