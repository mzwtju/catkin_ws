...
formation.append( [[-1,-1],[0,-1],[1,-1],[-1,0],[0,0],[1,0]])  #2x3 formation
                                                              #  i i i i i 
                                                              #  
formation.append(  [[-2,-2],[0,-2],[2,-2],[-1,-1],[0,0],[1,-1]] )#Trianglar formation[[-2,-2],[0,-2],[2,-2],[-1,-1],[0,0],[1,-1]]
                                                              #     i
                                                              #    i  i
                                                              #   i    i
formation.append( [[0,-4],[0,-2],[0,-6],[-2,0],[0,0],[2,0]]  )  #'T' formation[[0,-4],[0,-2],[0,-6],[-2,0],[0,0],[2,0]]
                                                              #    i i i
                                                              #      i
                                                              #      i
                                                              #    
formation.append( [[2,0],[0,0],[-2,0],[-4,0],[-6,0],[-8,0]]  )
formation_id = 0
