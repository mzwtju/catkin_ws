...
if __name__=="__main__":
   ...
   # uav_num = int(sys.argv[1])
    ...
    for i in range(uav_num): 
        multi_cmd_vel_flu_pub[i] = rospy.Publisher('/xtdrone/uav'+str(i)+'/cmd_vel_flu', Twist, queue_size=10) #i+1
        multi_cmd_pub[i] = rospy.Publisher('/xtdrone/uav'+str(i)+'/cmd',String,queue_size=10)                  #i+1
